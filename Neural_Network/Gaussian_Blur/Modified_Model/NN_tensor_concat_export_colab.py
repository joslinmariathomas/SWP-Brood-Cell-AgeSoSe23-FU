...
def save_tensor_and_ages(train_or_test: str, tensor_folder_path,
    ...
    for file_name in os.listdir(tensor_folder_path):
        ...
        if train_or_test == "test":
            label_file_name = os.path.splitext(file_name)[0]
            pred_label_folder =  '/content/SWP-Brood-Cell-AgeSoSe23-FU/Neural_Network/Gaussian_Blur/Predictions/True_test_labels'
...
def main():
    training_data_folder = '/content/SWP-Brood-Cell-AgeSoSe23-FU/Neural_Network/Gaussian_Blur/training_tensor_data/tensors/'
    training_labels_folder = '/content/SWP-Brood-Cell-AgeSoSe23-FU/Neural_Network/Gaussian_Blur/training_tensor_data/labels/'
    folder_to_save = '/content/SWP-Brood-Cell-AgeSoSe23-FU/Neural_Network/Gaussian_Blur/'
    save_tensor_and_ages(train_or_test="train",
                         tensor_folder_path=training_data_folder,
                         labels_folder=training_labels_folder,
                         folder_to_save = folder_to_save)
    testing_data_folder =  '/content/SWP-Brood-Cell-AgeSoSe23-FU/Neural_Network/Gaussian_Blur/testing_tensor_data/tensors/'
    testing_labels_folder =  '/content/SWP-Brood-Cell-AgeSoSe23-FU/Neural_Network/Gaussian_Blur/testing_tensor_data/labels/'
