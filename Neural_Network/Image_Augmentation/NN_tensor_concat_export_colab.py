...
def save_tensor_and_ages(train_or_test: str, tensor_folder_path,
    ...
    for file_name in os.listdir(tensor_folder_path):
        ...
        if train_or_test == "test":
            label_file_name = os.path.splitext(file_name)[0]
            pred_label_folder = '/content/SWP-Brood-Cell-AgeSoSe23-FU/Neural_Network/Image_Augmentation/Predictions/True_test_labels'
...
def main():
    ...
    folder_to_save = '/content/SWP-Brood-Cell-AgeSoSe23-FU/Neural_Network/Image_Augmentation'
