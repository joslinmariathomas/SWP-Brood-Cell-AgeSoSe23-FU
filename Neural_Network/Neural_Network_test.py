...
if __name__ == "__main__":
    ...
    test_true_ages_folder = '/content/SWP-Brood-Cell-AgeSoSe23-FU/Neural_Network/Predictions/True_test_labels'
    predictions_folder = '/content/SWP-Brood-Cell-AgeSoSe23-FU/Neural_Network/Predictions/Predicted_labels'
